...
public class DisponibilidadeCadastroCommand {
    ...
    public DisponibilidadeCadastroCommand(String diaSemana, LocalTime horaInicio, LocalTime horaFim, String diaMes, Integer fkFuncionario, Boolean disponibilidadeExcecao, String fkFuncionarioExcecaoNome) {
